...
class SongDetailsController:UIViewController{
                ...
                case .success(let upload, _, _):
                    upload.responseString { response in
                        ...
                        if response.description == "SUCCESS: 1"{
                            ...
                            CDAlertView(title: "Upload", message: "Unable To Share This Song", type: .error).show()
                        }
                    }
    ...
    func getYoutubeVideo(artist:String, song:String){
        ...
        //https://www.googleapis.com/youtube/v3/search?part=id&q=sia%20chandelier&safeSearch=moderate&maxResults=5&type=video&key=AIzaSyByp4usFJQ0srWjFv0P3QXv7WJpp1eKWQ4
        
        //https://www.googleapis.com/youtube/v3/search?part=id&q=&safeSearch=moderate&maxResults=5&type=video&key=AIzaSyByp4usFJQ0srWjFv0P3QXv7WJpp1eKWQ4
        ...
        Alamofire.request(url,method : .get ).responseJSON {
            ...
            case .success(let value) :
                ...
                let url = URLRequest(url: URL(string:self.youtubeUrl)!)
